...
## 🙌来自作者
大家好，由于本框架流程是在一步一步探索中实现的，因此最初版本的可读性较差。为了方便复现，我在开源前进行了较大范围的重构，但可能因此产生各种未能发现的问题，如路径不一致、缺少部分代码等。若大家复现过程中有任何疑惑或发现了bug，欢迎提issue或直接通过主页邮箱讨论，我会在空闲时间尽量解决！

## 模型开源
使用CSEC-C数据集训练后的模型已开源至huggingface，[点此跳转](https://huggingface.co/Hanyiton/VAA-CSEC/tree/main)。
